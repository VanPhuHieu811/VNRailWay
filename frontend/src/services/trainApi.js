...
export const createScheduleApi = async (data) => {
    return await client.post('/api/v1/admin/schedules', data);
};
...
export const getAllTrainsApi = async () => {
    return await client.get('/api/v1/trains');
};

export const getStationsByRouteApi = async (routeId) => {
    return await client.get(`/api/v1/master/stations/${routeId}`);
};
