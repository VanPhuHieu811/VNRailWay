...
const PassengerInfoPage = () => {
  ...
  const { selectedSeats, tripId } = location.state || { selectedSeats: [], tripId: '' };

  // Thông tin người liên hệ (Lấy từ user đăng nhập)
  ...
  useEffect(() => {
    // 1. Load thông tin người liên hệ
    ...
    // 2. Khởi tạo form hành khách (Thêm các trường mới: dob, phone, address)
  ...
  const handleContinue = () => {
    // Validate: Kiểm tra Tên, CMND và Ngày sinh (SĐT và Địa chỉ có thể tùy chọn)
      ...
      <div className="booking-content">
        ...
        <div className="seat-layout-container">
          ...
          <div className="passenger-section">
            {/* Card thông tin người liên hệ (Giữ nguyên) */}
            ...
            {selectedSeats.map((seat, index) => (
              <div key={seat.id} className="passenger-form-card">
                ...
                {/* Grid 2 cột cho các trường nhập liệu */}
