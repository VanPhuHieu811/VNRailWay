...
('TS001', N'Thời gian giữ vé', 30, NULL, '2024-01-01', NULL, N'Số phút giữ chỗ trước khi hủy'),
('TS002', N'Phí hủy vé', 10, NULL, '2024-01-01', NULL, N'Phần trăm phí hủy vé'),
('TS003', N'Phí đổi vé', 5, NULL, '2024-01-01', NULL, N'Phần trăm phí đổi vé');
GO
...
('NV002', 'GA01', '2024-01-01', '2025-12-31'),
('NV003', 'GA12', '2024-01-01', '2025-12-31');
GO
...
('CT001', 'GA01', '2024-12-01 19:00', '2024-12-01 19:00', '2024-12-01 19:05', '2024-12-01 19:05'),
('CT001', 'GA05', '2024-12-02 01:30', '2024-12-02 01:20', '2024-12-02 01:35', '2024-12-02 01:25'),
('CT001', 'GA08', '2024-12-02 10:00', '2024-12-02 09:50', '2024-12-02 10:10', '2024-12-02 10:00'),
('CT001', 'GA12', '2024-12-02 22:00', '2024-12-02 22:00', '2024-12-02 22:15', '2024-12-02 22:15'),
('CT003', 'GA01', '2024-12-28 19:00', '2024-12-28 19:00', '2024-12-28 19:00', '2024-12-28 19:00'),
('CT003', 'GA05', '2024-12-29 01:30', '2024-12-29 01:20', NULL, NULL),
('CT003', 'GA08', '2024-12-29 10:00', '2024-12-29 09:50', NULL, NULL),
('CT003', 'GA12', '2024-12-29 22:00', '2024-12-29 22:00', NULL, NULL),
('CT004', 'GA12', '2024-12-30 08:00', '2024-12-30 08:00', NULL, NULL),
('CT004', 'GA08', '2024-12-30 20:00', '2024-12-30 19:50', NULL, NULL),
('CT004', 'GA01', '2024-12-31 11:00', '2024-12-31 11:00', NULL, NULL),
('CT005', 'GA01', '2024-12-31 06:00', '2024-12-31 06:00', NULL, NULL),
('CT005', 'GA05', '2024-12-31 12:30', '2024-12-31 12:20', NULL, NULL),
('CT005', 'GA08', '2024-12-31 20:00', '2024-12-31 20:00', NULL, NULL),
('CT006', 'GA01', '2025-01-02 07:00', '2025-01-02 07:00', NULL, NULL),
('CT006', 'GA12', '2025-01-03 06:00', '2025-01-03 06:00', NULL, NULL);
GO
...
-- 17. DON_NGHI_PHEP
-- =============================================
INSERT INTO DON_NGHI_PHEP (MaDon, MaPhanCong, NgayGui, LyDo, NVGuiDon, NVQuanLy, NVThayThe, TrangThai) VALUES
('DNP001', 'PC005', '2024-12-27 08:00', N'Bị ốm đột xuất', 'NV005', 'NV001', 'NV004', N'Chấp nhận'),
('DNP002', 'PC007', '2024-12-27 09:00', N'Việc gia đình', 'NV011', 'NV001', 'NV008', N'Chấp nhận'),
('DNP003', 'PC008', '2024-12-28 10:00', N'Khám sức khỏe định kỳ', 'NV006', 'NV001', NULL, N'Đang chờ'),
('DNP004', 'PC010', '2024-12-28 14:00', N'Con ốm', 'NV012', 'NV001', NULL, N'Từ chối');
GO
...
('BL001', '2024-12-01 08:00', 'NV001', 25000000, 5000000, 0, 0, 0, 30000000),
('BL002', '2024-12-01 08:00', 'NV002', 12000000, 2000000, 0, 0, 0, 14000000),
('BL003', '2024-12-01 08:00', 'NV003', 12000000, 2000000, 500000, 0, 0, 13500000),
('BL004', '2024-12-01 08:00', 'NV004', 15000000, 3000000, 0, 2000000, 500000, 20500000),
('BL005', '2024-12-01 08:00', 'NV005', 15000000, 3000000, 0, 1500000, 0, 19500000),
('BL006', '2024-12-01 08:00', 'NV006', 15000000, 3000000, 0, 1000000, 0, 19000000),
('BL007', '2024-12-01 08:00', 'NV007', 13000000, 2500000, 0, 1500000, 0, 17000000),
('BL008', '2024-12-01 08:00', 'NV008', 13000000, 2500000, 0, 1000000, 500000, 17000000),
('BL009', '2024-12-01 08:00', 'NV009', 13000000, 2500000, 200000, 800000, 0, 16100000),
('BL010', '2024-12-01 08:00', 'NV010', 20000000, 3000000, 0, 0, 0, 23000000);
GO
...
('BG001', '2024-01-01 00:00', '2025-12-31 23:59', N'Hạng sang', N'Ghế', NULL, 'DT01', 100, 150000),
('BG002', '2024-01-01 00:00', '2025-12-31 23:59', N'Hạng sang', N'Ghế', NULL, 'DT02', 100, 150000),
('BG003', '2024-01-01 00:00', '2025-12-31 23:59', N'Hạng sang', N'Giường', 1, 'DT01', 100, 280000),
('BG004', '2024-01-01 00:00', '2025-12-31 23:59', N'Hạng sang', N'Giường', 2, 'DT01', 100, 250000),
('BG005', '2024-01-01 00:00', '2025-12-31 23:59', N'Hạng sang', N'Giường', 1, 'DT02', 100, 280000),
('BG006', '2024-01-01 00:00', '2025-12-31 23:59', N'Hạng sang', N'Giường', 2, 'DT02', 100, 250000),
('BG007', '2024-01-01 00:00', '2025-12-31 23:59', N'Bình thường', N'Ghế', NULL, 'DT03', 100, 100000),
('BG008', '2024-01-01 00:00', '2025-12-31 23:59', N'Bình thường', N'Ghế', NULL, 'DT04', 100, 100000);
GO
...
('DV001', 'thanhtung95@gmail.com', 'CT001', '2024-11-28 10:00', '2024-11-28 10:30', 2587500, N'Online', N'Đã thanh toán'),
('DV002', 'maimai98@gmail.com', 'CT001', '2024-11-29 14:00', '2024-11-29 14:30', 4830000, N'Online', N'Đã thanh toán'),
('DV003', 'hoangnam92@gmail.com', 'CT003', '2024-12-25 09:00', '2024-12-25 09:30', 2587500, N'Online', N'Đã thanh toán'),
('DV004', 'huong85@gmail.com', 'CT003', '2024-12-26 16:00', '2024-12-26 16:30', 4105500, N'Tại quầy', N'Đã thanh toán'),
('DV005', 'ducho60@gmail.com', 'CT004', '2024-12-28 08:00', '2024-12-28 08:30', 2199375, N'Online', N'Đã thanh toán'),
('DV006', 'lananh01@gmail.com', 'CT004', '2024-12-28 11:00', '2024-12-28 11:30', 2328750, N'Online', N'Đã thanh toán'),
('DV007', 'thanhtung95@gmail.com', 'CT004', '2024-12-27 15:00', '2024-12-27 15:30', 2587500, N'Online', N'Hủy'),
('DV008', 'hoangnam92@gmail.com', 'CT005', '2024-12-29 10:00', '2024-12-29 10:30', 791000, N'Online', N'Đang chờ');
GO
...
('VE001', 'KH001', 'CT001', 'DV001', 'BG001', NULL, '2024-11-28 10:15', 'GA01', 'GA12', 0, 2587500, N'Đã dùng', 'VT0101_01'),
('VE002', 'KH002', 'CT001', 'DV002', 'BG003', NULL, '2024-11-29 14:15', 'GA01', 'GA12', 0, 4830000, N'Đã dùng', 'VT0103_01'),
('VE003', 'KH003', 'CT003', 'DV003', 'BG001', NULL, '2024-12-25 09:15', 'GA01', 'GA12', 0, 2587500, N'Đã đặt', 'VT0101_05'),
('VE004', 'KH004', 'CT003', 'DV004', 'BG003', 'UD02', '2024-12-26 16:15', 'GA01', 'GA12', 724500, 4105500, N'Đã đặt', 'VT0103_05'),
('VE005', 'KH005', 'CT004', 'DV005', 'BG002', 'UD02', '2024-12-28 08:15', 'GA12', 'GA01', 388125, 2199375, N'Đã đặt', 'VT0201_01'),
('VE006', 'KH006', 'CT004', 'DV006', 'BG002', 'UD01', '2024-12-28 11:15', 'GA12', 'GA01', 258750, 2328750, N'Đã đặt', 'VT0201_02'),
('VE007', 'KH001', 'CT004', 'DV007', 'BG002', NULL, '2024-12-27 15:15', 'GA12', 'GA01', 0, 2587500, N'Hủy vé', 'VT0201_10'),
('VE008', 'KH003', 'CT005', 'DV008', 'BG007', NULL, NULL, 'GA01', 'GA08', 0, 791000, N'Giữ chỗ', 'VT0301_01'),
('VE009', 'KH009', 'CT003', 'DV004', 'BG001', 'UD03', '2024-12-26 16:15', 'GA01', 'GA12', 1293750, 1293750, N'Đã đặt', 'VT0101_06');
GO
...
('DV_01', 'NV002', 'VE003', 'VE005', '2024-12-28 09:00', 129375, 'Đã đổi');
GO
...
('HD001', 'DV001', NULL, NULL, '2024-11-28 10:20', N'Online', 2587500),
('HD002', 'DV002', NULL, NULL, '2024-11-29 14:20', N'Online', 4830000),
('HD003', 'DV003', NULL, NULL, '2024-12-25 09:20', N'Online', 2587500),
('HD004', 'DV004', NULL, 'NV002', '2024-12-26 16:20', N'Tại quầy', 5399250),
('HD005', 'DV005', NULL, NULL, '2024-12-28 08:20', N'Online', 2199375),
('HD006', 'DV006', NULL, NULL, '2024-12-28 11:20', N'Online', 2328750),
('HD007', NULL, 'DV_01', 'NV002', '2024-12-28 09:10', N'Tại quầy', 129375);
GO
